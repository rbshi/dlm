...
//      val dut = new LinkedListBB(32, 10)
//      dut
//    }.doSim("lldut", 99) { dut =>
...
//        for (k <- 1 to 4) {
//          cmdQueue += ((LLOp.ins, k, 0, false)) // insert queue header
//        }
//        for (k <- 5 to 12) {
//          cmdQueue += ((LLOp.ins, k, (k-1) % 4, true)) // insert queue body
//        }
...
//            println("[RECV] key:" + dut.io.ll_res_if.key.toBigInt + "\tresponse:" + dut.io.ll_res_if.rescode.toBigInt)
//          }
//        }
//      }
//
