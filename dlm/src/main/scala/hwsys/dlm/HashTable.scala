...
class hash_table_top(keyWidth:Int, valWidth:Int, bucketWidth:Int, tableAddrWidth:Int, pkgSurfix:String) extends BlackBox with RenameIO {
  ...
  addRTLPath("dlm/src/main/lib/HashTable/CRC32_D32.sv")
  addRTLPath("dlm/src/main/lib/HashTable/altera_avalon_st_pipeline_base.v")
  addRTLPath("dlm/src/main/lib/HashTable/calc_hash.sv")
  addRTLPath("dlm/src/main/lib/HashTable/data_table.sv")
  addRTLPath("dlm/src/main/lib/HashTable/data_table_delete.sv")
  addRTLPath("dlm/src/main/lib/HashTable/data_table_insert.sv")
  addRTLPath("dlm/src/main/lib/HashTable/data_table_insert2.sv")
  addRTLPath("dlm/src/main/lib/HashTable/data_table_search.sv")
  addRTLPath("dlm/src/main/lib/HashTable/data_table_search_wrapper.sv")
  addRTLPath("dlm/src/main/lib/HashTable/data_table_search_wrapper_1eng.sv")
  addRTLPath("dlm/src/main/lib/HashTable/empty_ptr_storage.sv")
  addRTLPath("dlm/src/main/lib/HashTable/synfifo.v")
  addRTLPath("dlm/src/main/lib/HashTable/hash_table_top.sv")
  addRTLPath("dlm/src/main/lib/HashTable/head_table.sv")
  addRTLPath("dlm/src/main/lib/HashTable/head_table_if.sv")
  addRTLPath("dlm/src/main/lib/HashTable/ht_cmd_if.sv")
  addRTLPath("dlm/src/main/lib/HashTable/ht_delay.sv")
  addRTLPath("dlm/src/main/lib/HashTable/ht_res_if.sv")
  addRTLPath("dlm/src/main/lib/HashTable/ht_res_mux.sv")
  addRTLPath("dlm/src/main/lib/HashTable/rd_data_val_helper.sv")
  addRTLPath("dlm/src/main/lib/HashTable/true_dual_port_ram_single_clock.sv")
